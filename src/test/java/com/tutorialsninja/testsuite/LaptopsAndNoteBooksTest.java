...
public class LaptopsAndNoteBooksTest extends BaseTest {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        assertAssert("MacBook not selected", laptopsAndNoteBooks.exptectedTextMessage("MacBook"), laptopsAndNoteBooks.actualTextToVerify(By.xpath("//h1[contains(text(),'MacBook')]")));
